...
#define STRING_CONFIG_H_AUTHOR "(Muschaw, default config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  14.81
    #define DEFAULT_Ki   2.84
    #define DEFAULT_Kd  19.29
  #endif
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 606, 606, 1167, 1241 }
